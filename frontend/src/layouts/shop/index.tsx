...
import Navbar from "@layouts/navigation/top-navbar";
import { getAuthCredentials, hasAccess } from "@utils/auth-utils";
import SidebarItem from "@layouts/navigation/sidebar-item";
import { siteSettings } from "@settings/site.settings";
import { useTranslation } from "next-i18next";
import MobileNavigation from "@layouts/navigation/mobile-navigation";
